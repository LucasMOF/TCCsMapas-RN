document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        // Atualiza o número total de TCCs (ignorando os IDs que pularam)
        document.getElementById('totalTccs').textContent = data.totalTccs;

        // Localiza o corpo da tabela e limpa
        const tbody = document.getElementById('tabela-professores');
        tbody.innerHTML = ''; 

        // Itera sobre a lista de professores e cria as linhas dinamicamente
